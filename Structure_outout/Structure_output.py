...
class Review(TypedDict):
    key_theams: Annotated[list[str], "must write 3 key themes"]
    summary: Annotated[str ,"must write a summary of the review in 20 words"]
    sentiment: Annotated[str, "must write the sentiment of the review,either positive, negative or neutral"]
...
new_propmts = "generate sentiment and summary of the review given. The review is '{prompts}'"
result = strutured_model.invoke(new_propmts)
